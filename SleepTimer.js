...
to {
  ...
  <div style="position: relative;">
      <button class="ZMXGDTbwxKJhbmEDZlYy control-button" aria-label="Sleep Timer" aria-expanded="false" onclick="SleepTimer()">
          <svg class="Svg-ytk21e-0 eqtHWV" xml:space="preserve" viewBox="0 0 1000 1000" y="0px" x="0px" height="16px" width="16px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1">
