  ...
  width: calc(100% - 20px);
    ...
    <div style="position: relative;">
        <button class="ZMXGDTbwxKJhbmEDZlYy control-button" aria-label="Sleep Timer" aria-expanded="false" onclick="SleepTimer()">
            <svg class="Svg-ytk21e-0 jAKAlG" xml:space="preserve" viewBox="0 0 1000 1000" y="0px" x="0px" height="16px" width="16px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1">
            <path d="M525.3,989.5C241.2,989.5,10,758.3,10,474.1c0-196.8,109.6-373.6,285.9-461.4c7.9-3.9,17.5-2.4,23.7,3.8c6.2,6.2,7.9,15.8,4,23.7c-32.2,65.4-48.5,135.7-48.5,208.9c0,261.4,212.7,474.1,474.1,474.1c74,0,145-16.7,211-49.5c7.9-3.9,17.5-2.4,23.7,3.8c6.3,6.3,7.9,15.8,3.9,23.7C900.5,879,723.3,989.5,525.3,989.5z"></path>
            </svg>
        </button>
        <div id="sleep-timer-menu" class="connect-device-list-container">
...
function SleepTimer() { // Toggle menu show
    ...
    if (menu.classList.contains('connect-device-list-container--is-visible')) menu.classList.remove('connect-device-list-container--is-visible');
    else menu.classList.add('connect-device-list-container--is-visible');
}
...
document.addEventListener('mouseup', event => {
    ...
    if (!menu.contains(event.target)) {
        document.querySelector('div#sleep-timer-menu').classList.remove('connect-device-list-container--is-visible');
    }
